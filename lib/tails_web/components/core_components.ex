defmodule TailsWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-14 shadow-lg ring-1 transition w-fit"
            >
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        <% end %>
        <thead class="text-sm text-left leading-6 text-zinc-500 dark:text-slate-300">
          <tr>
        ...
        <tbody
          ...
          class="relative divide-y divide-zinc-100 border-t border-zinc-200 dark:text-slate-300 text-sm leading-6 text-zinc-700"
        >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TailsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TailsWeb.Gettext, "errors", msg, opts)
    end
  end

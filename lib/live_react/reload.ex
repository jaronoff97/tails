defmodule LiveReact.Reload do
  @moduledoc """
  Utilities for Vite integration in development.
  In dev, loads assets from the Vite dev server for HMR.
  In prod, falls back to compiled assets.
  """
  ...
  def vite_assets(assigns) do
    ...
    ~H"""
    <%= if Application.get_env(:tails, :vite_host) do %>
      <script type="module">
